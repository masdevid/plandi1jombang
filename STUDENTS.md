...
- semester          -- 1 / 2
- score
- assessment_type   -- exam / assignment / remedial
- created_at
```
...
- rombel_id (FK → rombels)
- semester
- category         -- discipline / attitude / participation
- note
```

---

## J. (Optional but realistic) `transfers`
...
### A. Learning level (non-Dapodik, modern)
